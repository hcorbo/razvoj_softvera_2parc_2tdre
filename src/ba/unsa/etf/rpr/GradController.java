...
public class GradController {
    ...
    public ObservableList<String> listTipGrada;
    ...
    public void initialize() {
        ...
        listaTipova.add("Razvijen");
        listaTipova.add("Srednje razvijen");
        listaTipova.add("Nerazvijen");
        listTipGrada = FXCollections.observableArrayList(listaTipova);
    ...
    public void clickOk(ActionEvent actionEvent) {
        ...
        if(choiceTipGrada.getSelectionModel().getSelectedItem().equals("Razvijen")) grad = new RazvijeniGrad();
        else if (choiceTipGrada.getSelectionModel().getSelectedItem().equals("Srednje razvijen")) grad = new SrednjeRazvijeniGrad();
        else if (choiceTipGrada.getSelectionModel().getSelectedItem().equals("Nerazvijen")) grad = new NerazvijeniGrad();
